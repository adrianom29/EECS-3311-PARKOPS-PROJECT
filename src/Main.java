...
public final class Main {
    public static void main(String[] args) throws Exception {
        ...
        if (mode.equals("fixture")) {
            ...
            System.out.println(MiniJson.stringify(Fixture.booking()));
            System.out.println(MiniJson.stringify(Fixture.spaces()));
            return;
        }
        ...
        try {
            if (mode.equals("scripted")) {
                ...
                var input = MiniJson.object(
                        MiniJson.parse(replay.next(List.of(new ChatMessage("user", "Propose a replacement for B1")))));
                ...
                if (host == null || model == null || host.isBlank() || model.isBlank()) {
                    System.out.println(
                            "LIVE_RUN_PENDING_COURSE_ACCESS: configure the course-provided OLLAMA_CHAT_URL and OLLAMA_MODEL.");
                    System.exit(2);
                }
